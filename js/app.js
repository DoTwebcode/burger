    ...
    (() => {
        ...
        Parallax.Each = class {
            ...
            parameters(el, parameters) {
                if ("v" == parameters.axis) el.style.transform = `translate3D(${(parameters.direction * (this.value / parameters.coefficient * 4)).toFixed(2)}px,0,0) ${parameters.additionalProperties}`; else if ("h" == parameters.axis) el.style.transform = `translate3D(${(parameters.direction * (this.value / parameters.coefficient * 4)).toFixed(2)}px,0,0) ${parameters.additionalProperties}`;
            }
        };
        ...
        $(".menu--scroll").on("click", (function(event) {
            ...
            let id = $(this).attr("href"), topMove = $(id).offset().top;
            $("body,html").animate({
                scrollTop: topMove
            }, 1300);
        }));
